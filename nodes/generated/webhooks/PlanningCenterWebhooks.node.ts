...
const OPERATIONS: Operation[] = [
  ...
  {
    "id": "batchUpdateWebhookSubscriptions",
    "resource": "Webhook Subscription",
    "operation": "Batch Update Webhook Subscriptions",
    "description": "Planning Center does not document this endpoint and may change it without notice.\n\nCreates, updates, or removes webhook subscriptions for a URL.",
    "method": "POST",
    "path": "/webhooks/v2/batch_update",
    "deprecated": false,
    "isList": false,
    "lookupTarget": "batch update",
    "pathParameters": [],
    "queryParameters": [],
    "queryOptions": [],
    "attributeFields": [
